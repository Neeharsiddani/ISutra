...
export const VERIFIED_STANDARD_LIFECYCLES: VerifiedStandardLifecycle[] = [
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: Plain and Reinforced Concrete — Code of Practice (Fourth Revision). Verified lifecycle evidence: Reaffirmed by BIS Sectional Committee CED 2 in 2020 and 2025. Operates concurrently with Amendments 1 through 6 in the verified reference dataset.',
    verified_source_url:
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: Coarse and Fine Aggregate for Concrete — Specification (Third Revision). Verified lifecycle evidence: Reaffirmed in 2025 by CED 2. Superseded the second revision (IS 383:1970). Includes verified amendments on manufactured sand (2017) and recycled aggregates (2023).',
    verified_source_url:
      'https://www.services.bis.gov.in/php/BIS_2.0/bisconnect/knowyourstandards/indian_standards/isdetails/search',
    last_verified_at: '2026-09-18',
  },
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: High Strength Deformed Steel Bars and Wires for Concrete Reinforcement — Specification (Fourth Revision). Verified lifecycle evidence: Reviewed and reaffirmed in 2023 by CED 54. Superseded the third revision (IS 1786:1985). Active specification for mandatory ISI certification with Amendments 1 through 4.',
    verified_source_url:
      'https://www.services.bis.gov.in/php/BIS_2.0/bisconnect/knowyourstandards/indian_standards/isdetails/search',
    last_verified_at: '2026-09-18',
  },
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: Polyvinyl Chloride Insulated Unsheathed and Sheathed Cables/Cords with Rigid and Flexible Conductor for Rated Voltages Up to and Including 1100 V (Fourth Revision). Verified lifecycle evidence: Reviewed and reaffirmed in 2020 by ETD 9. Superseded the third revision (IS 694:1990). Product manual records amendments.',
    verified_source_url:
      'https://www.services.bis.gov.in/php/BIS_2.0/bisconnect/knowyourstandards/indian_standards/isdetails/search',
    last_verified_at: '2026-09-18',
  },
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: Textiles — Protective Clothing for Industrial Workers Exposed to Heat (First Revision). Verified lifecycle evidence: Superseded IS 15748:2007. Active specification updated by official amendments established in 2024 with Gazette-notified transition windows.',
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: Crosslinked Polyethylene Insulated Thermoplastic Sheathed Cables — Specification Part 1 For Working Voltages Up to and Including 1100 V (Third Revision). Verified lifecycle evidence: BIS implementation circular (CMD-III, August 2025) establishes that IS 7098 (Part 1):1988 was revised and published as IS 7098 (Part 1):2025, with concurrent running permitted until 09 Dec 2025. No verified amendment record in the current ISutra reference dataset for this edition.',
    verified_source_url:
      'https://www.services.bis.gov.in/php/BIS_2.0/bisconnect/knowyourstandards/indian_standards/isdetails/search',
    last_verified_at: '2026-09-18',
  },
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: Luminaires Part 5: Particular Requirements Section 3: Luminaires for Road and Street Lighting (Second Revision). Verified lifecycle evidence: Published March 13, 2026, superseding IS 10322 (Part 5/Sec 3):2012. No verified amendment record in the current ISutra reference dataset for this edition.',
    verified_source_url:
      'https://www.services.bis.gov.in/php/BIS_2.0/bisconnect/knowyourstandards/indian_standards/isdetails/search',
    last_verified_at: '2026-09-18',
  },
  ...
  // ------------------------------------------------------------
  {
    ...
    evidence_description:
      'Curated reference edition: Guide for Selection of Occupational Protective Clothing — Body Protection (Selection, Care and Maintenance) (First Revision). Verified lifecycle evidence: Published in 2024, superseding IS 8519:1977. No verified amendment record in the current ISutra reference dataset for this edition.',
    verified_source_url:
      'https://www.services.bis.gov.in/php/BIS_2.0/bisconnect/knowyourstandards/indian_standards/isdetails/search',
    last_verified_at: '2026-09-18',
  },
